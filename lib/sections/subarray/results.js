...
exports.compare = function compare(a, b) {
    ...
    if (equal(a, b)) {
        ...
        // same panel +95%
        var code_undefined = (a.result_set.code === undefined && b.result_set.code === undefined);
        var code_system_undefined = (a.result_set.code_system_name === undefined && b.result_set.code_system_name=== undefined);

        if (a.result_set.code === b.result_set.code && a.result_set.code_system_name === b.result_set.code_system_name && !code_undefined && !code_system_undefined) {
            pct = pct + 95;
