...
exports.compare = function compare(a, b) {
    ...
    if (equal(a, b)) {
        ...
        */
        ...
        var code_undefined = (a.vital.code === undefined && b.vital.code === undefined);
        var code_system_undefined = (a.vital.code_system_name === undefined && b.vital.code_system_name=== undefined);


        // same vital sign +50%
        if (a.vital.code === b.vital.code && a.vital.code_system_name === b.vital.code_system_name && !code_undefined && !code_system_undefined) {
            pct = pct + 50;
