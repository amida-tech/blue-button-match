...
exports.compare = function compare(a, b) {
    ...
    if (equal(a, b)) {
        ...
        if (utils.codeMatch(a.problem.code, b.problem.code, a.problem.code_system_name, b.problem.code_system_name) ) {
         ...
         else if (a.problem.name === b.problem.name && a.problem.name !== undefined && b.problem.name !== undefined) {
            pct = pct + 25;
            ...
            utils.isDefined(a.problem.code, b.problem.code, a.problem.code_system_name, b.problem.code_system_name)){
            pct = 0;
        }
