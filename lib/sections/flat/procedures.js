...
exports.compare = function compare(a, b) {
    ...
    if (equal(a, b)) {
        ...
        // same vital sign +50%
        if (utils.codeMatch(a.procedure.code, a.procedure.code_system_name, b.procedure.code, b.procedure.code_system_name) ) {
            pct = pct + 50;
        ...
        else if (a.procedure.name === b.procedure.name && a.procedure.name !== undefined && b.procedure.name !== undefined) {
            pct = pct + 30;
