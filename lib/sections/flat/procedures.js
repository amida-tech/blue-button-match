...
exports.compare = function compare(a, b) {
    ...
    if (equal(a, b)) {
        ...
        var code_undefined = (a.procedure.code === undefined && b.procedure.code === undefined);
        var code_system_undefined = (a.procedure.code_system_name === undefined && b.procedure.code_system_name=== undefined);


        // same vital sign +50%
        if (a.procedure.code === b.procedure.code && a.procedure.code_system_name === b.procedure.code_system_name && !code_undefined && !code_system_undefined) {
            pct = pct + 50;
