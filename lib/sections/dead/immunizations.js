    ...
    if (equal(a, b)) {
        ...
        */
        ...
        if (utils.codeMatchWithTranslation(a.product.product.code, a.product.product.code_system_name, a.product.product.translations,
            ...
            && utils.isDefined(a.product.product.code, b.product.product.code, a.product.product.code_system_name, b.product.product.code_system_name)){
            pct = 0;
        }
